...
class InstagramAPI:
    ...
    def getInbox(self):
        print(self.s.post(self.API_URL + "direct_v2/inbox",verify=False))
        ...
        self.s.headers.update (
            {
                ...
                'Connection': 'keep-alive',
                'Accept': '*/*',
                'Content-Type': 'multipart/form-data/application/x-www-form-urlencoded; charset=UTF-8; boundary={}'.format(boundary),
                'Accept-Language': 'en-en',
            }
        )
        #self.SendRequest(endpoint,post=data) #overwrites 'Content-type' header and boundary is missed
